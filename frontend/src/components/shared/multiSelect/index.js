...
class DropdownMultiSelect {
    ...
    link($scope, $element, $attrs, $document) {
        ...
        this.getPropertyForObject = function (object, property) {
        ...
        this.externalEvents.onInitDone();

        this.selectAll = function() {
            this.deselectAll(false);
            this.externalEvents.onSelectAll();
        ...
        this.deselectAll = function(sendEvent) {
        ...
        this.setSelectedItem = function(id, dontRemove) {
